...
class PageSearchResult():
    ...
    def search_criteria(self):
        from Components.search_critera import SearchCriteria
    ...
    def filter_sort(self):
        from Components.filter_sort import FilterSort
    ...
    def result_list_goods(self):
        from Components.result_list_goods import Result_list_goods
